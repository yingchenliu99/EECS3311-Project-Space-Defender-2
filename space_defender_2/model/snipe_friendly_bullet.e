note
	description: "Summary description for {SNIPE_FRIENDLY_BULLET}."
	author: ""
	date: "$Date$"
	revision: "$Revision$"

class
	SNIPE_FRIENDLY_BULLET
...
feature
    make_snipe(n_row:INTEGER;n_column:INTEGER;move_row:INTEGER; move_column:INTEGER; b_damage:INTEGER; b_move:INTEGER)
    do
      row:=n_row
      column:=n_column
      m_row:=move_row
